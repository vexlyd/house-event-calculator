...
# Creating two buttons, one called "Save Details" and the other called "Show Scores". The "Save
# Details" button will run the save function and the "Show Scores" button will run the print_details
# function.
